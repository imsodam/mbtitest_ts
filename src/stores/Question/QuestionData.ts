...
export const QuestionData: IQuestion[] = [
  ...
  { 
    id: 2, 
    title: '고양이에 대한 모든것이 궁금해졌다. 나의 행동은?', 
    answera: '고양이 관련 커뮤니티에 들어가서 다른 집사님들과 소통을 하며 고양이에 대한 지식을 쌓는다.', 
  ...
  { 
    ...
    answera: "'옴팡이 너무 이쁜것 같아.. 사람들한테 자랑해야지!!' 하며 인스타를 만들어서 사진도 공유하고 소통도 한다.", 
  ...
  { 
    id: 5, 
    title: '고양이에 대해서 모르는 부분을 검색하고 있다. 내가 글을 읽는 방법은?', 
  ...
  { 
    id: 6, 
    title: '고양이에게 밥을 주려고 한다. 나의 방법은?', 
    answera: '손, 눈대중으로 대층 이정도면 되겠지 하고 급여한다.', 
    answerb: '칼로리를 정확히 맞춰 저울이나 스푼으로 계량해서 급여한다.', 
    type: 'SN' 
  },
  { 
    id: 7, 
    title: '같은 집사 친구가 자신의 고양이가 아픈 것 같아 슬퍼하고 있다. 나의 반응은?', 
  ...
  { 
    ...
    answerb: '나이 의견이 상대방을 기분나쁘게 하지 않도록 잘 전달하려고 먼저 생각한다.', 
    type: 'TF' 
  },
  { 
    id: 9, 
  ...
  { 
    ...
    answera: '우리 고양이 몸무게는 5키로니까 하루세변 몇시에 이만큼씩 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리미리', 
